...
| Change delivery | point check, twice per row per subscriber | rows times subscribers, hot path | OpenFGA | **Built (R5b, 2026-08-12)** (the two-check form is **Decided (R6)**) |
